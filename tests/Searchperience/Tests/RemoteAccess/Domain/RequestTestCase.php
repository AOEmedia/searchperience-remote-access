...
class RequestTestCase extends \Searchperience\Tests\BaseTestCase {
	...
	public function testGetUrlWithRangeFacet() {
		$testUrl = 'http://google.de/index.php?id=0&searchperience%5Baction%5D=search&searchperience%5Bcontroller%5D=Search&dataType=html&eID=tx_aoesolr_search&searchperience%5Bfacetsel%5D%5Brange%5D%5Bprice%5D%5Bmin%5D=10&searchperience%5Bfacetsel%5D%5Brange%5D%5Bprice%5D%5Bmax%5D=100';
		$this->request->setEndPointHostname('http://google.de/');
	...
	public function testGetUrlWithCustomPath() {
		$testUrl = 'http://google.de/test/test?searchperience%5Baction%5D=search&searchperience%5Bcontroller%5D=Search&dataType=html&eID=tx_aoesolr_search';
		$this->request->setEndPointHostname('http://google.de/');
	...
	public function testCanUseDefaultEndPointHost() {
		...
		$this->assertEquals($this->request->getUrl(),'http://client.endpointsystem.de/index.php?id=foo&searchperience%5Baction%5D=search&searchperience%5Bcontroller%5D=Search&dataType=html&eID=tx_aoesolr_search');
	}
	...
	public function testCanChain() {
		$testUrl = 'http://google.de/index.php?id=0&tx_aoesolr_pi1%5Baction%5D=search&tx_aoesolr_pi1%5Bcontroller%5D=Search&dataType=html&eID=tx_aoesolr_search&tx_aoesolr_pi1%5Bfacetsel%5D%5Boption%5D%5Bbrand_s%5D%5B0%5D=puma&tx_aoesolr_pi1%5Bfacetsel%5D%5Boption%5D%5Bbrand_s%5D%5B1%5D=nike';
		$this->request->setEndPointHostname('http://google.de/')
	...
	public function testGetUrlWithEmptyPath() {
		$testUrl = 'http://google.de/?searchperience%5Baction%5D=search&searchperience%5Bcontroller%5D=Search&dataType=html&eID=tx_aoesolr_search';
		$this->request->setEndPointHostname('http://google.de/');
	...
	public function testSetQueryString() {
		$testUrl = 'http://google.de/index.php?id=0&tx_aoesolr_pi1%5Baction%5D=search&tx_aoesolr_pi1%5Bcontroller%5D=Search&dataType=html&eID=tx_aoesolr_search&tx_aoesolr_pi1%5Bfacetsel%5D%5Boption%5D%5Bcat_s%5D%5B0%5D=cloth&tx_aoesolr_pi1%5Bquerystring%5D=searching';
		$this->request->setEndPointHostname('http://google.de/');
		$this->request->setFacetOptionValue('cat_s', 'cloth');
		$this->request->setNamespace('tx_aoesolr_pi1');
